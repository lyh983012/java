...
public abstract class Deal implements Comparable<Deal>,Serializable {
	...
	public int compareTo_money(Deal temp) {
		Integer a=Integer.valueOf(this.amount);
		Integer b=Integer.valueOf(temp.amount);
		if(a>b)
			return 1;
		else
			return 0;
...
class TransferDeal extends Deal implements Serializable{
		Account inputAconut;
...
class NormalDeal extends Deal  implements Serializable{ //对象要想实现序列化，其所属的类必须实现Serializable接口
...
class StockDeal extends Deal implements Serializable{
